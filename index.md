...
- Недостатки: Так же как и Kitematic имеет ограниченный функционал. 
...
```
- Преимущества: OpenSource. Простой в использовании, русифицированный.
- Недостатки: Умеет проверять состояние контейнеров. Распространяется и разворачивается как Docker-образ.  
